...
def isValidWord(word, hand, wordList):
    ...
    for letter in word:
      if letter in hand.keys() and handCopy[letter] > 0:
        handCopy[letter] -= 1
      else:
        return False
    ...
    while calculateHandlen(hand) > 0:
        ...
        # Otherwise (the input is not a single period):
            ...
            # Otherwise (the word is valid):
                ...
                print userInput + "earned " + str(wordScore) + " points. Total score: " + str(totalScore) + " points."
                # Update the hand 
...
testHands = ({'h': 1, 'i': 1, 'c': 1, 'z': 1, 'm': 2, 'a': 1},
