...
class AndTrigger(Trigger):
  ...
  def evaluate(self, story):
    return self.o1.evaluate(story) and self.o2.evaluate(story)
...
class OrTrigger(Trigger):
  ...
  def evaluate(self, story):
    return self.o1.evaluate(story) or self.o2.evaluate(story)
...
def makeTrigger(triggerMap, triggerType, params, name):
    ...
    if triggerType == "SUBJECT":
      newtrigger = SubjectTrigger(s.join(params))
    elif triggerType == "TITLE":
      newtrigger = TitleTrigger(s.join(params))
    elif triggerType == "SUMMARY":
      newtrigger = SummaryTrigger(s.join(params))
      ...
      newtrigger = PhraseTrigger(s.join(params))
