...
def buildCoder(shift):
    ...
    for i in range(len(string.ascii_uppercase)):
      d[string.ascii_uppercase[i]] = (2*string.ascii_uppercase)[i + shift]
    # lowercase characters
    for i in range(len(string.ascii_lowercase)):
      d[string.ascii_lowercase[i]] = (2*string.ascii_lowercase)[i + shift]
    return d
...
def decryptStory():
    ...
    """
    ### TODO.
    return applyShift(getStoryString(),
        findBestShift(wordList, getStoryString()))
